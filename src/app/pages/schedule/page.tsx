...
export default function SchedulePage() {
  ...
  return (
    <>
    <div className="bg-gradient-to-br from-black via-gray-900 to-blue-950 min-h-screen text-pink-400">
      <Header />
      <div className="p-6 max-w-7xl mx-auto">
        <h1 className="text-4xl font-extrabold text-center mb-10 mt-[100px] bg-gradient-to-r from-pink-500 to-purple-700 text-transparent bg-clip-text">
