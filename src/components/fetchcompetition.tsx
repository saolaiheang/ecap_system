      ...
      <table className="min-w-full text-base text-left border-collapse border border-gray-300">
        <thead className="bg-blue-900 text-white text-lg text-center">
          <tr>
            ...
            <th className="border px-6 py-4">Location</th>
            <th className="border px-6 py-4">Start Date</th>
        ...
        <tbody>
          {competitions.map((comp, index) => (
            ...
            >
              <td className="border px-6 py-4">{comp.name}</td>
              <td className="border px-6 py-4">{comp.location}</td>
