    ...
    <section className="bg-white py-20 px-6 md:px-12 lg:px-24">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
          ...
          both on and off the field. It brings people together, regardless of
          background, to foster unity, inclusion, and peace. For young people
          especially, sport is a powerful tool for building confidence,
