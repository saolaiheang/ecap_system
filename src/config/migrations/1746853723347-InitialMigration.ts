...
export class InitialMigration1746853723347 implements MigrationInterface {
    name = 'InitialMigration1746853723347'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "sport_type" ("id" uuid NOT NULL, "name" character varying(255) NOT NULL, "description" character varying(1000) NOT NULL, CONSTRAINT "PK_535b2e60d204c943cedec8c9cfe" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "competition" ("id" uuid NOT NULL, "name" character varying(255) NOT NULL, "sport_type_id" uuid NOT NULL, "start_date" date NOT NULL, "location" character varying(200) NOT NULL, CONSTRAINT "PK_a52a6248db574777b226e9445bc" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "player" ("id" uuid NOT NULL, "name" character varying(200) NOT NULL, "position" character varying(250) NOT NULL, "team_id" uuid NOT NULL, "contact_info" character varying(250) NOT NULL, CONSTRAINT "PK_65edadc946a7faf4b638d5e8885" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "coach" ("id" uuid NOT NULL, "name" character varying(200) NOT NULL, "team_id" uuid NOT NULL, "contact_info" character varying(200) NOT NULL, CONSTRAINT "PK_c2ca0875fe0755b197d0147713d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "team" ("id" uuid NOT NULL, "name" character varying(200) NOT NULL, "division" character varying(50) NOT NULL, "sport_type_id" uuid NOT NULL, "contact_info" character varying(300) NOT NULL, CONSTRAINT "PK_f57d8293406df4af348402e4b74" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "match" ("id" uuid NOT NULL, "match_date" date NOT NULL, "location" character varying(255) NOT NULL, "competition_id" uuid NOT NULL, "sport_type_id" uuid NOT NULL, CONSTRAINT "PK_92b6c3a6631dd5b24a67c69f69d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "match" ADD CONSTRAINT "FK_6cb4e6e3c53cd63546a744a1290" FOREIGN KEY ("competition_id") REFERENCES "competition"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "match" DROP CONSTRAINT "FK_6cb4e6e3c53cd63546a744a1290"`);
